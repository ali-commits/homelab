...
**RedRipper** is a comprehensive homelab infrastructure running **44 containerized services** on Fedora 43 Server, delivering enterprise-grade capabilities for media streaming, cloud storage, AI/ML workloads, and system monitoring. Built with security, performance, and automation at its core.
...
- **Container Orchestration**: 44 services across 7 categories with Traefik routing
...
| **🔧 Productivity Tools**       | 12        | Forgejo, N8N, Syncthing, IT-Tools, Excalidraw | Git hosting, automation, file sync, dev utilities |
...
| **🔐 Security & Communication** | 4         | Zitadel, ntfy, Postfix, Tuwunel           | SSO, notifications, SMTP relay, private Matrix chat |

**Total: 44 Production Services** | [📖 Complete Service Reference](docs/docker/00_README.md)
