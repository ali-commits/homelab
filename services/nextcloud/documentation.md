...
Nextcloud is integrated with Authentik for Single Sign-On (SSO) authentication, providing centralized user management.
...
- REST API token: [Authentik API Token]
- Group mapping:
  - Authentik Group: `Nextcloud Users`
  - Nextcloud Group: `users`

### Group-Based Access Control

Access to Nextcloud is restricted to members of the "Nextcloud Users" group in Authentik. This is configured by:

1. Creating a "Nextcloud Users" group in Authentik
